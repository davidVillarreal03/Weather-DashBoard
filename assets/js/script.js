...
currentWeatherDiv.innerHTML = `<div class="card-panel blue darken-1">
...
const temperatureFahrenheitForecast = convertCelsiusToFahrenheitAndRound(day.main.temp);
    ...
    if (!uniqueDays[formattedDate]) {
        const cardHtml = `<div class="card-panel z-depth-4 text-align center blue darken-1">
...
searchHistoryDiv.innerHTML += `<div  class="card-panel blue darken-1">${currentWeatherData.name}</div>`;
